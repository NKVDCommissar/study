...
def validate_even(title):
    if title[0] == "?":
        raise ValidationError("Заголовок не может начинаться с вопросительного знака")


class Advertisement(models.Model):
    title = models.CharField("Заголовок", max_length=120, null=True, validators=[validate_even])
    ...
    image = models.ImageField('изображение', blank=True, upload_to='advertisements/')
